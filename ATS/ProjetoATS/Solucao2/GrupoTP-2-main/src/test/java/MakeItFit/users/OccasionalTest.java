...
public class OccasionalTest {
    ...
    @Test
    public void testSetFrequencyWithNegativeValueThrowsException() {
        Occasional user = new Occasional("José Fernandes", 45, Gender.Male, 75, 175, 67, 6, "Braga", "990 000 000", "josefernandes@mail.com", 2);
    ...
    @Test
    public void testToStringIncludesFrequency() {
        Occasional user = new Occasional("José Fernandes", 45, Gender.Male, 75, 175, 67, 6, "Braga", "990 000 000", "josefernandes@mail.com", 2);
