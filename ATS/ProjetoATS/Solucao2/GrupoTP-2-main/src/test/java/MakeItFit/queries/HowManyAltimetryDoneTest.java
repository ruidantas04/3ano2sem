...
public class HowManyAltimetryDoneTest {
    ...
    @Test
    void testExecuteQueryWithNoAltimetryActivities() {
        UserManager emptyManager = new UserManager();
        User noActivitiesUser = new Amateur("No Act", 25, Gender.Female, 60, 165, 55, 2, "Rua X", "912345678", "no@act.com");
        emptyManager.insertUser(noActivitiesUser);

        HowManyAltimetryDone altimetryAnalyzer = new HowManyAltimetryDone();
        double result = altimetryAnalyzer.executeQuery(emptyManager, "no@act.com");
