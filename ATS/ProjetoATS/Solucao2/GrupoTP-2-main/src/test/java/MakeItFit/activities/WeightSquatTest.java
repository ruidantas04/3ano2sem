...
public class WeightSquatTest {
    ...
    public void testEqualsDifferentClass() {
        WeightSquat squat = new WeightSquat();
        assertNotEquals(squat, new Object(), "WeightSquat should not be equal to an object of another class");
    }
    ...
    public void testToString() {
        ...
        assertTrue(result.contains("WeightSquat") || !result.isEmpty(), "toString() should return a non-empty string");
    }

    @Test
    public void testClone() {
        WeightSquat original = new WeightSquat();
        WeightSquat copy = original.clone();

        assertNotSame(original, copy, "Clone should create a different object");
        assertEquals(original, copy, "Clone should be equal in content");
    }
