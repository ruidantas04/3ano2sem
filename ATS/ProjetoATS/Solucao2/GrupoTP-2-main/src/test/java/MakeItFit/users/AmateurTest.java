...
public class AmateurTest {
    ...
    public void testToString() {
        Amateur user = new Amateur("José Fernandes", 45, Gender.Male, 75, 175, 67, 6, "Braga", "990 000 000", "josefernandes@mail.com");
        String output = user.toString();
        assertTrue(output.contains("José Fernandes"));
        assertTrue(output.contains("Braga"));
    }

    @Test
    public void testEqualsBehavior() {
        Amateur user1 = new Amateur("José Fernandes", 45, Gender.Male, 75, 175, 67, 6, "Braga", "990 000 000", "josefernandes@mail.com");
        Amateur user2 = new Amateur("José Fernandes", 45, Gender.Male, 75, 175, 67, 6, "Braga", "990 000 000", "josefernandes@mail.com");

        // Se o método equals estiver implementado em User, isto deve ser true
