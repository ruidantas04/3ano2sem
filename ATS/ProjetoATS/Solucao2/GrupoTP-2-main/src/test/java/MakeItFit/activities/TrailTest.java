...
public class TrailTest {
    ...
    public void testSetTrailTypeOutOfBounds() {
        ...
        assertEquals(Trail.TRAIL_TYPE_EASY, trail.getTrailType(), "Should default to EASY when below bounds");

        trail.setTrailType(99);
        assertEquals(Trail.TRAIL_TYPE_HARD, trail.getTrailType(), "Should cap at HARD when above bounds");
    }

    @Test
    public void testEqualsDifferentClass() {
        Trail trail = new Trail();
        assertNotEquals(trail, new Object(), "Should not be equal to different class");
    }
    ...
    public void testClone() {
        ...
        assertNotSame(trail, cloned, "Clone should create a different object");
        assertEquals(trail, cloned, "Clone should be equal in content");
    }
    ...
    public void testToString() {
        ...
        assertTrue(result.contains("Trail Type:"), "toString() should contain trail type");
    }
