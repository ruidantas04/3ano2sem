...
void prepareCylinder(float altura, float raio, int lados) {
	...
	for (int i = 0; i < lados; ++i) {
		...
		t[vertex * 2 + 0] = 0.1875 * sin(i * delta) + 0.4375;
		t[vertex * 2 + 1] = 0.1875 * cos(i * delta) + 0.1875;
		...
		t[vertex * 2 + 0] = 0.1875 * sin((i + 1) * delta) + 0.4375;
		t[vertex * 2 + 1] = 0.1875 * cos((i + 1) * delta) + 0.1875;
		...
		t[vertex * 2 + 0] = 0.1875 * sin((i + 1) * delta) + 0.8125;
		t[vertex * 2 + 1] = 0.1875 * cos((i + 1) * delta) + 0.1875;
		...
		t[vertex * 2 + 0] = 0.1875 * sin(i * delta) + 0.8125;
		t[vertex * 2 + 1] = 0.1875 * cos(i * delta) + 0.1875;
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(float) * vertexCount * 3, t, GL_STATIC_DRAW);
